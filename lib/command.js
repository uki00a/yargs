...
import { inspect, path, require } from './compat.js'
import Parser from './port/yargs-parser/index.js'
...
// arguments.
export default function command (yargs, usage, validation, globalMiddleware) {
  const self = {}
  let handlers = {}
  let aliasMap = {}
  let defaultCommand
