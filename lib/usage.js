...
import { decamelize, stringWidth, setBlocking, cliui } from './deps.js'
import objFilter from './obj-filter.js'
import { path, process } from './compat.js'
import YError from './yerror.js'

export default function usage (yargs, y18n) {
  const __ = y18n.__
  const self = {}
