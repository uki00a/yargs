...
namespace yargsParser {
  ...
  export interface Parser {
      (argv: string | string[], opts?: yargsParser.Options): yargsParser.Arguments;
      detailed(argv: string | string[], opts?: yargsParser.Options): yargsParser.DetailedArguments;
  }
}
...
namespace yargs {
  ...
  type ParserConfigurationOptions = yargsParser.Configuration & {
